...
3. Enter the [`source/`](../source) directory
4. Run `make flatpak`

Note that this will automatically add the Flathub repository as a remote and install dependencies from there. See [`source/Makefile`](../source/Makefile) for details.
