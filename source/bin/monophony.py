...
for var in ('GTK_THEME', 'GTK_STYLE_OVERRIDE', 'GTK2_RC_FILES'):
	if var in os.environ:
		try:
			os.environ.pop(var)
		except KeyError:
			logboth.error(__name__, f'Failed to unset {var}')
		else:
			logboth.warning(__name__, f'Unset {var} to prevent GTK theme override issues')
